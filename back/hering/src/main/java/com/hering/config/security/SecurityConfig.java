package com.hering.config.security;
...
import com.hering.config.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig  {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests((requests) -> requests
		            ...
		            .requestMatchers(HttpMethod.PATCH, "/tasks/complete/**").hasAnyRole("USER", "ADMIN")
